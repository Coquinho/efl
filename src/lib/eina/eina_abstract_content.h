 ...
 */
typedef Eina_Content* (*Eina_Content_Convertion_Callback)(Eina_Content *from, const char *to_type);
 ...
 */
EAPI Eina_Bool eina_content_converter_conversion_register(const char *from, const char *to, Eina_Content_Convertion_Callback convertion);
 ...
 */
EAPI Eina_Iterator* eina_content_converter_possible_converstions(const char *from);
 ...
 */
EAPI Eina_Value* eina_value_content_new(Eina_Content *value);
 ...
 */
EAPI Eina_Value eina_value_content_init(Eina_Content *value);
...
eina_content_possible_converstions(Eina_Content *content)
{
   return eina_content_converter_possible_converstions(eina_content_type_get(content));
}
