...
_efl_ui_selection_selection_get(Eo *obj EINA_UNUSED, Efl_Ui_Selection_Privat_Data *pd, Efl_Ui_Cnp_Buffer buffer, unsigned int seat, Eina_Iterator *acceptable_types)
{
   return ecore_evas_selection_get(pd->ee, seat, _ee_buffer_get(buffer), acceptable_types);
}

EOLIAN static void
_efl_ui_selection_selection_set(Eo *obj EINA_UNUSED, Efl_Ui_Selection_Privat_Data *pd, Efl_Ui_Cnp_Buffer buffer, Eina_Content *content, unsigned int seat)
{
   ecore_evas_selection_set(pd->ee, seat, _ee_buffer_get(buffer), content);
}

EOLIAN static void
_efl_ui_selection_selection_clear(Eo *obj EINA_UNUSED, Efl_Ui_Selection_Privat_Data *pd, Efl_Ui_Cnp_Buffer buffer, unsigned int seat)
{
   ecore_evas_selection_set(pd->ee, seat, _ee_buffer_get(buffer), NULL);
}

EOLIAN static Eina_Bool
_efl_ui_selection_has_selection(Eo *obj EINA_UNUSED, Efl_Ui_Selection_Privat_Data *pd, Efl_Ui_Cnp_Buffer buffer, unsigned int seat)
{
   return ecore_evas_selection_exists(pd->ee, seat, _ee_buffer_get(buffer));
}

EOLIAN static Efl_Object*
_efl_ui_selection_efl_object_constructor(Eo *obj, Efl_Ui_Selection_Privat_Data *pd)
{
...
EOLIAN static void
_efl_ui_selection_efl_object_invalidate(Eo *obj, Efl_Ui_Selection_Privat_Data *pd)
{
   if (pd->registered)
     {
...
EOLIAN static Eina_Bool
_efl_ui_selection_efl_object_event_callback_priority_add(Eo *obj, Efl_Ui_Selection_Privat_Data *pd,
...
EOLIAN static Eina_Bool
_efl_ui_selection_efl_object_event_callback_array_priority_add(Eo *obj, Efl_Ui_Selection_Privat_Data *pd,
...
EOLIAN static Efl_Object*
_efl_ui_selection_efl_object_finalize(Eo *obj, Efl_Ui_Selection_Privat_Data *pd)
{
   if (pd->registered)
     _selection_changed_event_register(obj);
